      ...
      <HStack>
        ...
        <VStack w='50%'>
          ...
          <Input
            ...
            onChangeText={(watering) => setCurrentFlower({ ...currentFlower, watering })}
          />
        </VStack>
      </HStack>
      <HStack>
        ...
        <VStack w='50%'>
          ...
          <Input
            ...
            onChangeText={(fertilization) => setCurrentFlower({ ...currentFlower, fertilization })}
          />
        </VStack>
      </HStack>
      <HStack>
        <VStack w='50%'>
          ...
          <Input
            ...
            onChangeText={(replanting) => setCurrentFlower({ ...currentFlower, replanting })}
          />
        </VStack>
      </HStack>
    </View>
